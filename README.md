# LUMI AI Factory Infrastructure for AI Agents
...
- An Apptainer definition file for building the container. Running the agent inside a container
  allows the user to very effectively limit its access to files.
- An `AGENTS.md` file, which contains basic information on using LUMI, including available Slurm
  partitions.
